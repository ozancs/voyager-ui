...
export const LANGS = [
  ['en', 'English'], ['de', 'Deutsch'], ['es', 'Español'], ['fr', 'Français'], ['it', 'Italiano'], ['nl', 'Nederlands'],
  ['pl', 'Polski'], ['pt', 'Português (Brasil)'], ['tr', 'Türkçe'], ['ru', 'Русский'], ['uk', 'Українська'],
...
function initial() {
  try { const l = localStorage.getItem('voyager-ui-lang'); if (l && CODES.includes(l)) return l } catch {}
...
export async function loadLang(l) {
  ...
  try { DICT[l] = markRaw((await loaders[`./locales/${l}.js`]()).default); i18n.ver++ } catch (e) { console.warn('language', l, e) }
}
export async function setLang(l) {
  ...
  try { localStorage.setItem('voyager-ui-lang', l) } catch {}
}

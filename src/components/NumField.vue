...
watch(() => props.modelValue, (v) => { if (!editing.value) local.value = v })
...
.nf-l { font-size: 13px; font-weight: 500; color: var(--mu); }
.nf-b { display: flex; align-items: center; height: 40px; background: var(--s2); border: 1px solid transparent; border-radius: var(--rb); overflow: hidden; }
.nf-b:focus-within { border-color: var(--ac); }

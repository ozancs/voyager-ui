...
<style scoped>
.lp { margin: 8vh auto 0; width: min(420px, 100%); background: var(--s1); border-radius: var(--r); padding: 20px 22px; display: flex; flex-direction: column; gap: 14px; }
.lp.compact { margin: 24px auto; }
.hd { display: flex; align-items: center; gap: 10px; font-size: 16px; }
.hd :deep(svg) { color: var(--heat); }
.list { display: flex; flex-direction: column; gap: 6px; }
.it { display: flex; align-items: center; gap: 10px; font-size: 13.5px; color: var(--tx); }
.it.mu { color: var(--mu); }
.dot { width: 6px; height: 6px; border-radius: 3px; background: var(--heat); animation: pulse 1s ease-in-out infinite; flex-shrink: 0; }
.s { color: var(--mu2); font-size: 12px; }

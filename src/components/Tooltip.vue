...
<style scoped>
.tt { position: fixed; z-index: 500; transform: translate(-50%, -100%); background: #2a2e34; color: var(--tx); border: 1px solid var(--bd); padding: 6px 10px; border-radius: 8px; font-size: 12px; font-weight: 600; pointer-events: none; white-space: nowrap; box-shadow: 0 6px 20px rgba(0,0,0,.4); }
.tt.below { transform: translate(-50%, 0); }
</style>

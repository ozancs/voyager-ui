...
function handle(m){
  ...
  switch(m.method){
    ...
    case 'machine.update.upgrade': setTimeout(()=>{let n=0;const t=setInterval(()=>{n++;wsAll({jsonrpc:'2.0',method:'notify_update_response',params:[{application:p.name,proc_id:1,message:'Updating step '+n,complete:n>=6}]});if(n>=6)clearInterval(t)},300)},100); return 'ok'
    ...
    case 'machine.update.status': return {version_info:{klipper:{version:'v0.13.0-300',remote_version:'v0.13.0-310',commits_behind:[1]},moonraker:{version:'v0.9.3',remote_version:'v0.9.3'},'voyager-ui':{version:'v0.14.5',remote_version:'v'+__APP_VERSION__},system:{package_count:0}}}

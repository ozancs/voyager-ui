...
export function sectionLinks(docUrl, title) {
  ...
  const handlers = EditorView.domEventHandlers({
    ...
    keydown(e, view) { if (e.key === 'Control' || e.key === 'Meta') setCtrl(view, true); return false },
    keyup(e, view) { if (e.key === 'Control' || e.key === 'Meta') setCtrl(view, false); return false },
    mousemove(e, view) { setCtrl(view, e.ctrlKey || e.metaKey); return false },
    blur(e, view) { setCtrl(view, false); return false },
  })
